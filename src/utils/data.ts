...
export const socialLinks: SocialLink[] = [
  { name: 'GitHub', url: 'https://github.com/Sabboo5', icon: 'github' },
  { name: 'LinkedIn', url: 'https://linkedin.com/in/sabonamisgana', icon: 'linkedin' },
  { name: 'Facebook', url: 'https://facebook.com/sabboonaa.mkabboomaa', icon: 'facebook' },
];
...
export const experiences: Experience[] = [
  {
    ...
    description: [
      ...
      'Developed core system features including clearance requests, approval tracking, status notifications, and report generation.',
      'Collaborated with supervisors and end users to gather requirements and test system functionality.',
    ],
    type: 'work',
  },
  {
    ...
    endDate: 'Present',
    description: [
      'Developed responsive and user-friendly websites using modern web technologies such as HTML5, CSS3, JavaScript, and React.js.',
